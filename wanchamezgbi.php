...
//echo $ኢሜል;
       ...
       echo '<td>' . $cid . '</td>';
        ...
        echo "</form>";
        $insert =	mysqli_query($conn," INSERT INTO `wancha_acchivers`(`Gibi_ID`, `ስም`, `ስልክ`, `ክህነት`,
         `የትምህርት_ደረጃ`, `ኢሜል`, `የትምህርት_ክፍል`, `የክርስትና-ስም`,`ዓም`) VALUES
          ('$cid ','$ስም ','$ስልክ','$ክህነት','$የትምህርት_ደረጃ','$ኢሜል ','$የትምህርት_ክፍል','$የክርስትናስም','$ዓም') ");
        ...
        {	
           ...
           echo "<script>window.location='wanchawoch.php';</script>";
