...
<div class="row">
    <div class="col-3">
                ...
                <input  class="form-control" type="text" name="id" required pattern="[A-Za-z0-9]+" x-moz-errormessage="Enter character to university ID"/> 
    </div>
    <div class="col-3">
 ...
 <div class="row">
    ...
    <font color="red">*</font><label><h5>የክርስትና-ስም</h5></label>
				...
				<input type="text"  class="form-control"  name="religiousname" pattern="[A-Za-z]+" required x-moz-errormessage="Enter character to  religious name" />
				
    </div>
    <div class="col-3">
    <font color="red">*</font><label><h5>የትምህርት_ደረጃ</h5></label>
				
				<input type="text"  class="form-control"  name="year" pattern="[0-9a-z]+" required x-moz-errormessage="Enter character to  religious name" />
				
    </div>
  </div>
    <div class="row">
    <div class="col-3">
    <font color="red">*</font><label><h5>አቅራቢያ ቤተ-ክርስቲያን</h5></label>
                
                <input type="text"  class="form-control"  name="church" pattern="[A-Za-z]+" required x-moz-errormessage="Enter character to  religious name" />
                
    </div>
    <div class="col-3">
    <font color="red">*</font><label><h5>ክልል</h5></label>
				
				<input type="text"  class="form-control"  name="region" pattern="[A-Za-z]+" required x-moz-errormessage="Enter character to  Region"  />
				
    </div>
<div class="col-3">
<font color="red">*</font><label><h5>ዞን</h5></label>
				
				<input type="text"  class="form-control"  name="zone" pattern="[A-Za-z]+" required x-moz-errormessage="Enter character to  Zone"  />
</div>
<div class="col-3">
<font color="red">*</font><label><h5>ወረዳ</h5></label>
       ...
       <div class="row">
        ...
        <font color="red">*</font><label>የቅርብ-ተጠሪ_ስም</label>
				...
				<input type="text"  class="form-control"  name="emergenceyname" pattern="[A-Za-z]+" required x-moz-errormessage="Enter character to  emergencey name"  />
               
        </div>
        <div class="col-3">
        <font color="red">*</font><label>የቅርብ-ተጠሪ_ስልክ</label>
				
				<input type="text"  class="form-control"  name="emergenceyphone" pattern="[0-9]+" required x-moz-errormessage="Enter character to  emergencey phone"  />
       ...
       <div class="row">
        ...
        <input type="text"  class="form-control"  name="ordination" pattern="[A-Za-z]+" required x-moz-errormessage="Enter character to ordination" />
				
        </div>
        <div class="col-3">
        <label for="insert the screen shoot">ፎቶ</label>
         <input type="file" name="myimage" id="img" class="form-control"  accept=".JPG, .PNG, .JPEG,">
     ...
     <div class="col-3">
                ...
                <font color="red">*</font><label>ዓ/ም</label> 
                <input   class="form-control"  type="text" name="accadamicyear" placeholder="" required title="enter phone number"/><br/><br/>
