...
//echo $ኢሜል;
       ...
       echo '<td>' . $cid . '</td>';
        ...
        echo "</form>";
        $insert =	mysqli_query($conn," INSERT INTO `temeraki`(`Gibi_ID`, `ስም`, `የትምህርት_ከፍል`, `ስልክ`,
         `ኢሜል`, `የትምህርት_ደረጃ`, `ክህነት`, `የክርስትና-ስም`,`ዓም`) VALUES
          ('$cid ','$ስም ','$የትምህርት_ክፍል','$ስልክ','$ኢሜል','$የትምህርት_ደረጃ ','$ክህነት','$የክርስትናስም','$ዓም') ");
          if(!$insert)
        {
        echo "Error".die();
        }
        ...
        {	
           ...
           echo "<script>window.location='graduations.php';</script>";
